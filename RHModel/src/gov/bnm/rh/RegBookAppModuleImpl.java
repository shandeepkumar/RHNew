...
import gov.bnm.rh.views.auditTrailViewRowImpl;
...
public class RegBookAppModuleImpl extends ApplicationModuleImpl implements RegBookAppModule {
    ...
    /**
     *  New method using for fetch all documents... 
     *
     */
        ...
        try {
            ...
            if ("EX".equalsIgnoreCase(isInternalExternal)) {
                ...
                if (!orgId.equals("()")) {
                    ...
                    /*
                     * 
                     * comments on 20th Oct 2019 regarding the RH CR document, 11 task.
                     * 
                    ViewObjectImpl voOrg = this.getOrganizationView1();
                    ...
                    */
                    ...
                    // start RH CR 20th Oct 2019 regarding the 11 task.
                    ViewObjectImpl voInstSector =
                        this.getInstitutionTypeSectorView1();
                    voInstSector.setWhereClause("INSTTYPEID IN " + instTypeId);
                    voInstSector.executeQuery();
                    
                    Row row = voInstSector.first();
                    if (row != null) {
                        sectorId =
                                "(".concat(this.getAllInString(voInstSector, "SectorID").concat(")"));
                        sectorId = sectorId.replace(",)", ")");
                    }
                    // end RH CR 20th Oct 2019 
    ...
    public void filterPolicyActiveOnlyViewUserIdAndDocumentType(String userId, 
        ...
        log.info("Consultation Id read value from config file --> " + consultId);
        log.info("Open Status --> " + openStatus);
        log.info("Close Status -->" + closeStatus);
        

        ViewObjectImpl vo = this.getPolicyActiveOnlyViewObj1();
        ViewObjectImpl vo2 = this.getPolicyActiveOnlyViewObj2();
        try {
        
            log.info("isInternalExternal :  " + isInternalExternal);
            
//             int iOpenStatus = Integer.parseInt(openStatus);
//             openStatus = (openStatus.equals("1")) ? "ACTIVE":"";
//             int iCloseStatus = Integer.parseInt(closeStatus);
//             closeStatus = (closeStatus.equals("0")) ? "ARCHIVE":"";
            ...
            if ("EX".equalsIgnoreCase(isInternalExternal)) {
                ...
                ViewObjectImpl voExOrg = this.getExternaluserorganizationView1();
                voExOrg.setWhereClause("USERID='" + userId + "'");
                voExOrg.executeQuery();

                String orgId = "(".concat(this.getAllInString(voExOrg, "ORGID").concat(")"));
                orgId = orgId.replace(",)", ")");

                if (!orgId.equals("()")) {

                    ViewObjectImpl voOrgInst = this.getOrganizationinstitutiontypeMultiView1();
                    voOrgInst.setWhereClause("ORGID IN " + orgId);
                    voOrgInst.executeQuery();

                    instTypeId = "(".concat(this.getAllInString(voOrgInst, "INSTTYPEID").concat(")"));
                    instTypeId = instTypeId.replace(",)", ")");
                    ...
                    String sqlStr = null;
                    if (orgId != null && orgId != "") {
                        sqlStr = "SELECT DISTINCT itemId FROM [dbo].[PolicyOrganizationPartition] WHERE id IN " +
                                 orgId;
                        ViewObject voOrgPart = this.createViewObjectFromQueryStmt("orgParam", sqlStr);
                        policyOrgId = this.getAllInString(voOrgPart, "itemId");
                        voOrgPart.remove();
                    }
                    ...
                    if (sectorId != null && sectorId != "") {
                        ...
                        sqlStr = "SELECT DISTINCT itemId FROM [dbo].[PolicyBusinessSectorPartition1] WHERE ID IN" + 
                                 sectorId;
                        ViewObject voSec = this.createViewObjectFromQueryStmt("secParam", sqlStr);
                        policySectorId = this.getAllInString(voSec, "itemId");
                        voSec.remove();
                    }

                    if (instTypeId != null && instTypeId != "" && !instTypeId.equals("()")) {
                        
                        sqlStr = "SELECT DISTINCT itemId FROM [dbo].[PolicyInstitutionTypePartition] WHERE id IN " +
                                instTypeId;
                        ViewObject voInst = this.createViewObjectFromQueryStmt("instParam", sqlStr);
                        policyInstType = this.getAllInString(voInst, "itemId");
                        voInst.remove();
                    }

                    if (policyOrgId != "" || policySectorId != "" || policyInstType != "") {
                        ...
                        vo.setWhereClause("isActive=" + iOpenStatus + " AND RecordStatus IN ('" + openStatus + "', 'AMENDHIS') AND NewIssuanceDate <=GETDATE() AND itemId IN" + policyOrgId);
                        vo2.setWhereClause("isActive=" + iOpenStatus + " AND RecordStatus IN ('" + openStatus + "','AMENDHIS')  AND NewIssuanceDate <=GETDATE() AND itemId IN" + policyOrgId);
                    } 
                    else {
                        vo.setWhereClause("DocCategory IN (" + consultId + ") AND isActive=" + iOpenStatus + " AND RecordStatus IN ('" + openStatus + "')  AND NewIssuanceDate <=GETDATE() AND itemId =''");
                        vo2.setWhereClause("DocCategory IN (" + consultId + ") AND isActive=" + iCloseStatus + " AND RecordStatus IN ('" + closeStatus + "')  AND NewIssuanceDate <=GETDATE() AND itemId =''");
                    }
                } 
                else {
                    vo.setWhereClause("DocCategory IN (" + consultId + ") AND  isActive=" + iOpenStatus + " AND RecordStatus IN ('" + openStatus + "')  AND NewIssuanceDate <=GETDATE()  AND itemId =''");
                ...
                vo.setWhereClause("DocCategory IN (" + consultId + ") AND  isActive=" + iOpenStatus + " AND RecordStatus IN ('" + openStatus + "')  AND NewIssuanceDate <=GETDATE() ");
                vo2.setWhereClause("DocCategory IN (" + consultId + ") AND  isActive=" + iCloseStatus + " AND RecordStatus IN ('" + closeStatus + "')  AND NewIssuanceDate <=GETDATE() ");
            }
            vo.executeQuery();
            vo2.executeQuery();
            log.info("vo getQuery :" + vo.getQuery());
...
*/
    ...
    /**
     * Audit trail function CR 13, 22 OCt 2019
     */
    public void submitAuditTrail(String usrId, String documentId, String notes, String actionTaken){
        //AuditTrailViewRowImpl auditRow = 
    }
 ...
 getDBTransaction().createCallableStatement("begin ? := " + stmt + ";end;", 0);
    ...
    /**
     * Container's getter for PolicyView10.
     * @return PolicyView10
     */
    public ViewObjectImpl getPolicyView10() {
        return (ViewObjectImpl)findViewObject("PolicyView10");
    }


    /**
     * Container's getter for RelavantActView1.
     * @return RelavantActView1
     */
    public ViewObjectImpl getRelavantActView1() {
        return (ViewObjectImpl)findViewObject("RelavantActView1");
    }

    /**
     * Container's getter for PolicyRelavantActPartitionView2.
     * @return PolicyRelavantActPartitionView2
     */
    public ViewObjectImpl getPolicyRelavantActPartitionView2() {
        return (ViewObjectImpl)findViewObject("PolicyRelavantActPartitionView2");
    }

    /**
     * Container's getter for PolicyRelavantActPartitionRelavantActViewLink.
     * @return PolicyRelavantActPartitionRelavantActViewLink
     */
    public ViewLinkImpl getPolicyRelavantActPartitionRelavantActViewLink() {
        return (ViewLinkImpl)findViewLink("PolicyRelavantActPartitionRelavantActViewLink");
    }


    /**
     * Container's getter for PolicyRelavantActPartitionView1.
     * @return PolicyRelavantActPartitionView1
     */
    public ViewObjectImpl getPolicyRelavantActPartitionView1() {
        return (ViewObjectImpl)findViewObject("PolicyRelavantActPartitionView1");
    }

    /**
     * Container's getter for RelavantActView2.
     * @return RelavantActView2
     */
    public ViewObjectImpl getRelavantActView2() {
        return (ViewObjectImpl)findViewObject("RelavantActView2");
    }

    /**
     * Container's getter for PolicyRelavantActPartitionRelavantActLink1.
     * @return PolicyRelavantActPartitionRelavantActLink1
     */
    public ViewLinkImpl getPolicyRelavantActPartitionRelavantActLink1() {
        return (ViewLinkImpl)findViewLink("PolicyRelavantActPartitionRelavantActLink1");
    }

    /**
     * Container's getter for PolicyIssuringDepartPartitionView1.
     * @return PolicyIssuringDepartPartitionView1
     */
    public ViewObjectImpl getPolicyIssuringDepartPartitionView1() {
        return (ViewObjectImpl)findViewObject("PolicyIssuringDepartPartitionView1");
    }

    /**
     * Container's getter for IssuringDepartmentView1.
     * @return IssuringDepartmentView1
     */
    public ViewObjectImpl getIssuringDepartmentView1() {
        return (ViewObjectImpl)findViewObject("IssuringDepartmentView1");
    }

    /**
     * Container's getter for PolicyActiveOnlyViewObj2.
     * @return PolicyActiveOnlyViewObj2
     */
    public ViewObjectImpl getPolicyActiveOnlyViewObj2() {
        return (ViewObjectImpl)findViewObject("PolicyActiveOnlyViewObj2");
    }

    /**
     * Container's getter for InstitutionTypeSectorView1.
     * @return InstitutionTypeSectorView1
     */
    public ViewObjectImpl getInstitutionTypeSectorView1() {
        return (ViewObjectImpl)findViewObject("InstitutionTypeSectorView1");
    }

    /**
     * Container's getter for InstitutionTypeSectorView2.
     * @return InstitutionTypeSectorView2
     */
    public ViewObjectImpl getInstitutionTypeSectorView2() {
        return (ViewObjectImpl)findViewObject("InstitutionTypeSectorView2");
    }

    /**
     * Container's getter for DocCategoryReadOnlyViewObj1.
     * @return DocCategoryReadOnlyViewObj1
     */
    public ViewObjectImpl getDocCategoryReadOnlyViewObj1() {
        return (ViewObjectImpl)findViewObject("DocCategoryReadOnlyViewObj1");
    }

    /**
     * Container's getter for auditTrailView1.
     * @return auditTrailView1
     */
    public ViewObjectImpl getauditTrailView1() {
        return (ViewObjectImpl)findViewObject("auditTrailView1");
    }


    /**
     * Container's getter for AuditTrailsView1.
     * @return AuditTrailsView1
     */
    public ViewObjectImpl getAuditTrailsView1() {
        return (ViewObjectImpl)findViewObject("AuditTrailsView1");
    }

    /**
     * Container's getter for PolicyOpenConsultantView1.
     * @return PolicyOpenConsultantView1
     */
    public ViewObjectImpl getPolicyOpenConsultantView1() {
        return (ViewObjectImpl)findViewObject("PolicyOpenConsultantView1");
    }

    /**
     * Container's getter for PolicyCloseConsultantView1.
     * @return PolicyCloseConsultantView1
     */
    public ViewObjectImpl getPolicyCloseConsultantView1() {
        return (ViewObjectImpl)findViewObject("PolicyCloseConsultantView1");
    }
}
