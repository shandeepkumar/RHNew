...
// ---    Fri Mar 28 04:09:32 GMT 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class EnquiryfaqForFaqManViewRowImpl extends ViewRowImpl {
    /**
     * AttributesEnum: generated enum for identifying attributes and accessors. DO NOT MODIFY.
     */
    public enum AttributesEnum {
    Abstract11 {
      public Object get(EnquiryfaqForFaqManViewRowImpl obj) {
        return obj.getAbstract11();
      }

      public void put(EnquiryfaqForFaqManViewRowImpl obj, Object value) {
    ...
    private static final int firstIndex = 0;
        ...
        public abstract Object get(EnquiryfaqForFaqManViewRowImpl object);

        public abstract void put(EnquiryfaqForFaqManViewRowImpl object,
                                 Object value);
  ...
  public static final int POLICYFAQVIEW = AttributesEnum.PolicyFaqView.index();

  /**
   * This is the default constructor (do not remove).
   */
    public EnquiryfaqForFaqManViewRowImpl() {
    }
   ...
   */
    ...
    /**
     * Gets the associated <code>Row</code> using master-detail link PolicyFaqView.
     */
    public Row getPolicyFaqView() {
        return (Row)getAttributeInternal(POLICYFAQVIEW);
    }

    /**
     * Sets the master-detail link PolicyFaqView between this object and <code>value</code>.
     */
    public void setPolicyFaqView(Row value) {
        setAttributeInternal(POLICYFAQVIEW, value);
    }
