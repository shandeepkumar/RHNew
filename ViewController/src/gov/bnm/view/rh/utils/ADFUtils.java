...
public class ADFUtils {
    ...
    public static Row getDcIteratorBindingCurrentRow(String iteratorName,
                                                     int rowId) {
        DCIteratorBinding listIter = ADFUtils.findIterator(iteratorName);
        return listIter.getRowAtRangeIndex(rowId);
    }
    ...
    public static Object bindingsOperationProcess(String operationType) {
        Object result = null;
        try {
            BindingContainer bindings = ADFUtils.getBindingContainer();
            OperationBinding operationBinding =
                bindings.getOperationBinding(operationType);
            result = operationBinding.execute();
            if (!operationBinding.getErrors().isEmpty()) {
                return result;
            }
        } catch (Exception e) {
            LOGGER.severe("Exception @bnmDecisionCommit .. " + e);
        }
        return result;
    }

    public static DCIteratorBinding getDcIteratorBinding(String iteratorName) {
        DCBindingContainer dcContainer = ADFUtils.getDCBindingContainer();
        return (DCIteratorBinding)dcContainer.findIteratorBinding(iteratorName);
    }
