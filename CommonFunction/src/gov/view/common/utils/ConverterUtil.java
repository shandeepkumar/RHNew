 ...
 * <p> Standardize formatting amount field for rover</p>
 * @version 1.0
 * @since 02 MAY 2011 Rover 2.0
 *
 */
public class ConverterUtil {
     ...
     *	
     */
    public static Double RinggitCutter(Double value,
                                       RoundingMode roundingMode) {
        return converterDoubleCutter(value, 0.00, "#########0.00",
                                     roundingMode);
    }
     ...
     *	
     */
    public static Double RinggitCutter(String value,
                                       RoundingMode roundingMode) {
        return converterDoubleCutter(value, "0.00", "#########0.00",
                                     roundingMode);
    }
     ...
     * @since Rover 2.0
     */
    public static String formatDouble(String value, String defaultValue,
                                      String format) {
     ...
     * @since Rover 2.0
     */
    public static String formatDouble(Double value, String defaultValue,
                                      String format) {
     ...
     * @since Rover 2.0
     */
    public static BigDecimal defaultIfEmpty(BigDecimal value,
    ...
    public static Double converterDoubleCutter(Double value,
                                               Double defaultValue,
                                               String format,
                                               RoundingMode roundingMode) {
    ...
    public static Double converterDoubleCutter(String value,
                                               String defaultValue,
                                               String format,
                                               RoundingMode roundingMode) {
        Double convertDouble = 0.00;
